...
//    탭 텍스트, 아이콘 리스트 생성 및 초기화.
    private val tabTextList = listOf("MyPage", "ToDoList", "Add ToDo", "Graph")
    private val tabIconList = listOf(R.drawable.profile_icon, R.drawable.list_icon, R.drawable.add_icon, R.drawable.graph_icon)
